...
The upshot is that gender classification achieves good results nearing in best case 90% accuracy while age prediction is a much more demanding task - the best mean absolute error achieved is approximately 6.35 years. However, in the last notebook we shed some light on specific factors that influence this score and theorize that under certain circumstances it might be possible to drive this value down, even below 4.5 years.
